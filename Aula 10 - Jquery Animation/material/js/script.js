...
$("#animacao2").on('click',function(){
 ...
 $("#animacao8").on('click',function(){
    ...
    $("img").attr("src","https://img.freepik.com/fotos-gratis/um-cachorrinho-que-esta-andando-na-neve_1340-37228.jpg?size=626&ext=jpg&ga=GA1.1.1413502914.1697414400&semt=ais")
